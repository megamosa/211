...
namespace MagoArab\WhatsappChat\Controller\Adminhtml\Settings;
...
class Index extends Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('MagoArab_WhatsappChat::whatsapp_chat_settings');
